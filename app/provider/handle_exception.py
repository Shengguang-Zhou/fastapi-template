...
from app.exceptions.exception import AuthenticationError, AuthorizationError, InternalServerError
...
def register(app):
    ...
    async def authorization_exception_handler(request: Request, e: InternalServerError):
        """
        内部服务器异常处理
        """
